...
export const SUPPLIER_REGEX = /^supplier_[1-9A-HJ-NP-Za-km-z]{35}$/
export const ORGANISATION_REGEX = /^org_[1-9A-HJ-NP-Za-km-z]{35}$/
export const USER_REGEX = /^user_[1-9A-HJ-NP-Za-km-z]{35}$/

export const DEVICE_PREFIX = 'device_'
export const KEY_PREFIX = 'key_'
export const SUPPLIER_PREFIX = 'supplier_'
export const ORGANISATION_PREFIX = 'org_'
